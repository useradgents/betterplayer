...
import 'package:better_player/src/flutter_to_airplay.dart';
...
class AirPlayRoutePickerView extends StatefulWidget {
  ...
  Map<String, dynamic> _createParams() {
    ...
    return <String, dynamic>{
      ...
      if (activeTintColor != null) 'activeTintColor': FlutterToAirplay.colorToParams(activeTintColor!),

      // if backgroundColor is not provided, do not process this.
      if (backgroundColor != null) 'backgroundColor': FlutterToAirplay.colorToParams(backgroundColor!),
    };
  }
